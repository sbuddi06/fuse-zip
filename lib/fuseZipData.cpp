...
FuseZipData::FuseZipData(const char *archiveName, struct zip *z, const char *cwd,
        bool force_precise_time, const char *password):
    m_zip(z), m_archiveName(archiveName), m_cwd(cwd), m_force_precise_time(force_precise_time), m_password(password) {
}
